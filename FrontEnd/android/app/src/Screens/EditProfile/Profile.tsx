        ...
        <ScrollView style={styles.container}>
                ...
                <View style={styles.viewbannerProfile}>
                    ...
                    <View style={styles.viewInformation}>
                        ...
                        <View style={styles.viewRank}>
                            ...
                            <Image style={styles.icon} source={require('../../Image/star.png')}></Image>
                        </View>
                    </View>
                    <Image style={styles.iconstar} source={require('../../Image/edit.png')}></Image>
                </View>
            </View>
            <View style={{ paddingTop:10 ,paddingBottom:20,}}>
                <View style={styles.viewVerify}>
                    <Text style={styles.textVerify}>Xác thực tài khoản giúp tài khoản bảo mật tốt hơn</Text>
                    <View style={{ paddingTop:10, paddingBottom:8 , paddingRight:10,}}>
                        <TouchableOpacity style={styles.Button} onPress={ useNavigationVerifyEmail}>
            ...
            <View style={styles.viewStar}>
                <View style={styles.viewStarUser}>
                    <Image style={styles.imageStar} source={require('../../Image/star1.png')}></Image>
                ...
                <View style={styles.viewStarUser}>
                    <Image style={styles.imageStar} source={require('../../Image/voucherss.png')}></Image>
                    <View style={styles.viewQuatityStar}>
            ...
            <View style={styles.setupInformation}>
                <View style={styles.viewInfomation}>
                    <TouchableOpacity onPress={useNavigationSetUpAccount} style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/users.png')}></Image>
                        <Text style={styles.text}>Thuyết lập tài khoản</Text>
                    </TouchableOpacity>
                    <Image style={styles.Image} source={require('../../Image/ten.png')}></Image>
                </View>
                <View style={styles.viewInfomation}>
                    <View style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/sound.png')}></Image>
                ...
                <View style={styles.viewInfomation}>
                    <View style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/dark.png')}></Image>
                ...
                <View style={styles.viewInfomation}>
                    <View style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/language.png')}></Image>
                        <Text style={styles.text}>Ngôn ngữ</Text>
                    </View>
                    <View style={{ flexDirection:'row',gap:10 }}>
                        <Text style={{ color:'#fff', marginTop:3 }}>Tiếng Việt</Text>
                        <Image style={styles.Image} source={require('../../Image/ten.png')}></Image>
                    </View>
                </View>
                <View style={styles.viewInfomation}>
                    <View style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/history.png')}></Image>
                ...
                <View style={styles.viewInfomation}>
                    <View style={{ flexDirection:'row', gap:10}}>
                        <Image style={styles.Image} source={require('../../Image/Rating.png')}></Image>
